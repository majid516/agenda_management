...
//   @override
//   State<Agend> createState() => _AgendaHomeScreenState();
// }
...
class AgendaHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (agendaState.errorMessage.isNotEmpty) {
      log(agendaState.errorMessage);
      return Scaffold(
        body: Center(child: Text(agendaState.errorMessage, style: TextStyle(color: Colors.red))),
      );
    }
